...
### 📸 Visual Workflow & Data Output

#### Make.com Scenario Integration
![Make Workflow](Screenshot%202026-09-25%20make_Integration%20APIFY.png)

#### Extracted Data Sample in Google Sheets
![Google Sheets Output](Screenshot%202026-09-25%20fisier_gSheetOutput.png)

---

## 📁 Repository Assets
* [`Integration Apify.blueprint.json`](./Integration%20Apify.blueprint.json) — Complete Make.com scenario export (importable blueprint).
* [`Centralizator_Evenimente.csv`](./Centralizator_Evenimente.csv) — Sample dataset generated by the automated pipeline.
